...
#define Rpwm_pin  6    //pin of controlling speed---- ENA of motor driver board
...
unsigned char Lpwm_val =120;//the speed of left wheel at 120 in initialization
unsigned char Rpwm_val = 120;//the speed of right wheel at 120 in initialization
...
void M_Control_IO_config(void)//initialized function of IO of motor driver
{
  ...
  pinMode(Rpwm_pin,OUTPUT); // pin 6 (PWM) --ENB of motor driver board  
}
void Set_Speed(unsigned char pwm)//setting function of speed
{
